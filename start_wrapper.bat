...
echo A project from VisualPlugin originally adapted by Yugandar
echo Adapted by YugandarAnimate
...
echo A project from VisualPlugin adapted by YugandarAnimate
echo:
